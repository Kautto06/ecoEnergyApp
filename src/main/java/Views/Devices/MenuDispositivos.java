 ...
 * @author alvar
 */
public class MenuDispositivos extends javax.swing.JFrame {
    private String rut;
    private int idHome;
    ...
    private void initComponents() {
        ...
        Modificar.setText("Modificar un dispositivo");
        ...
        Eliminar.setText("Eliminar un dispositivo");
        ...
        Modificar1.setText("Mostrar dispositivos");
    ...
    private void VolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VolverActionPerformed
        ...
        menuPrincipal.setRutLogeado(rut);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuDispositivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuDispositivos().setVisible(true);
            }
        });
    }
