...
public class MenuAgregar extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(89, 89, 89)
                                .addComponent(Invalido1, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void confirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarActionPerformed
        ...
        user=userController.obtenerUsuarioPorRut(idUser);

        UltimoDig=controllerHome.obtenerUltimoIdDeHomes()+1;
        ...
        {
            Home NewHome= new Home(UltimoDig,RutCompania, InputNombre.getText(),InputTipoAmbiente.getText(),idUser);
            controllerHome.agregarHomeABD(NewHome);
            controllerHome.agregarUsersHome("S",idUser,UltimoDig);
            JOptionPane.showMessageDialog(this, "Home agregada correctamente");
            Invalido1.setVisible(false);
